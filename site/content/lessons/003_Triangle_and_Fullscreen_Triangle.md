...
> Note: If you've heard of Mesh Shaders, well we don't have access to those, but what you learn here regarding Vertex shaders should mostly apply there, as it replaces all of the geometry related stages.
