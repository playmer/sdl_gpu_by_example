...
TechniqueContext CreateTechniqueContext(SDL_GPUTextureFormat aDepthFormat) {
  ...
  {
    static const float3 cPositions[] = {
    ...
    static const float3 cColors[] = {
      { 1.0f, 0.0f, 0.0f }, // top left forward
      { 0.0f, 1.0f, 0.0f }, // top right forward
      { 0.0f, 0.0f, 1.0f }, // bottom left foward
      { 1.0f, 1.0f, 1.0f }, // bottom right forward
      { 0.0f, 0.0f, 0.0f }, // top left back
      { 1.0f, 1.0f, 0.0f }, // top right back
      { 1.0f, 0.0f, 1.0f }, // bottom left back
      { 0.0f, 1.0f, 1.0f }, // bottom right back
    };
    ...
    context.mModel.mMeshes->mVertexCount = SDL_arraysize(cPositions);
